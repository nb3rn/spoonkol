...
echo $green." ╔═╗┌─┐┌─┐┌┬┐ ╔═╗┌─┐┬ ┬ ╚═╗├─┘├─┤│││ ║ ├─┤│ │ X [POS] ╚═╝┴ ┴ ┴┴ ┴ ╚═╝┴ ┴┴─┘┴─┘\n".$blue. "Perkumpulan Orang Spam"; 
echo $red." [!] Author : Mr.yM						[!] [!] Youtube : www.youtube.com/MAULANARyM [!] [!] github : github.com/MaulanaRyM [!]\n"; 
echo $green." ====================================== |[!] Thanks To Army Cyber Network [!]| ======================================\n"; 
echo "\n"; 
echo "\n"; 
echo "+-----------------------------------+\n"; 
echo "| [!] 0852***** or 62852****** [!] |\n"; 
